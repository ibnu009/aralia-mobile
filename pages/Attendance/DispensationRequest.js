...
class DispensationRequest extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
...
export default connect(mapStateToProps)(DispensationRequest);
